...
def _candidate_scenario_response(scenario: Scenario | None) -> CandidateScenarioRead:
    ...
    return CandidateScenarioRead(
        ...
        visible_requirements=scenario.visible_requirements or scenario.technical_requirements,
        starter_files_json=scenario.starter_files_json,
        test_files_json=scenario.test_files_json,
        ...
        ai_mode=scenario.ai_mode or scenario.interview.allowed_ai_mode,
...
def submit_session_solution(
    ...
    session.last_autosaved_at = now
    session.status = InterviewSessionStatus.READY_FOR_REVIEW
